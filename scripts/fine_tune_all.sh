...
#         python interpret_predictions.py --train_dataset "$train_set" --seed "$seed" --model_type bert --model_name_or_path bert-base-cased --scenario final
#         # test DT2 -> ori1 s.d ori5
#         # test DT3 -> rem1 s.d rem5
#         # test DT4 -> low1 s.d low5
#         for eval_set in "${eval_sets[@]}"; do
...
#         python interpret_predictions.py --train_dataset "$train_set" --seed "$seed" --model_type distilbert --model_name_or_path distilbert-base-cased --scenario final
#         # test DT2 -> ori1 s.d ori5
#         # test DT3 -> rem1 s.d rem5
#         for eval_set in "${eval_sets[@]}"; do
...
#         python interpret_predictions.py --train_dataset "$train_set" --seed "$seed" --model_type distilbert --model_name_or_path distilbert-base-uncased --scenario final
#         # test DT2 -> ori1 s.d ori5
#         # test DT3 -> rem1 s.d rem5
#         for eval_set in "${eval_sets[@]}"; do
...
# train original
    # test DT1 -> original
        ...
        python interpret_predictions.py --train_dataset "$train_set" --seed "$seed" --model_type xlnet --model_name_or_path xlnet-base-cased --scenario final
        # test DT2 -> ori1 s.d ori5
        # test DT3 -> rem1 s.d rem5
        # for eval_set in "${eval_sets[@]}"; do
...
#         # python interpret_predictions.py --train_dataset "$train_set" --seed "$seed" --model_type albert --model_name_or_path albert/albert-base-v2 --scenario final
#         # test DT2 -> ori1 s.d ori5
#         # test DT3 -> rem1 s.d rem5
#         for eval_set in "${eval_sets[@]}"; do
...
#         python interpret_predictions.py --train_dataset "$train_set" --seed "$seed" --model_type electra --model_name_or_path google/electra-base-discriminator --scenario final
#         # test DT2 -> ori1 s.d ori5
#         # test DT3 -> rem1 s.d rem5
#         for eval_set in "${eval_sets[@]}"; do
